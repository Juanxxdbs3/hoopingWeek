...
return function($app) {
    ...
    $app->get('/api/fields/{field_id}/exceptions', [OperatingHoursController::class, 'getException']);
    $app->get('/api/fields/{field_id}/exceptions/range', [OperatingHoursController::class, 'getExceptionsByRange']); // ← AGREGAR
